...
import mrmrsrcf from "../../../images/mrmrsrcf.jpeg";
          ...
          <div>
            <div className="text-center">
              ...
              <h1 className="md:text-[64px] text-[42px] font-[700] md:leading-[82px] leading-[60px] my-[1.8rem]">
                COME WITH YOUR EXPECTATIONS TO:
              </h1>
            </div>
            ...
            <div className="flex md:flex-row flex-col my-10">
              <div className="md:w-[40%] p-10 py-14 bg-[#FFF5EB]">
                ...
                <p className="my-3">
                  ...
                  atque. Lorem ipsum dolor sit amet consectetur dadipisicing
                  elit. Laudantium, error.
                </p>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <a href="https://wa.me/+2347085151218">
                    <Button name={"REGISTER"} dark />
                  </a>
                </div>
              </div>
              <div className="md:w-[50%]">
                <img src={mrmrsrcf} alt="" />
              </div>
            </div>
          </div>
        </div>
